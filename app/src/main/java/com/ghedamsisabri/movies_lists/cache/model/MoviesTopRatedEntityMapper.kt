...
class MoviesTopRatedEntityMapper: DomainMapper<MovieTopRatedEntity, Movies> {
    override fun mapToDomainModel(model: MovieTopRatedEntity): Movies {
        return(Movies(
            id = model.id,
            adult=model.adult,
    ...
    override fun mapFromDomainModel(domainModel: Movies): MovieTopRatedEntity {
    ...
    fun fromEntityList(initial: List<MovieTopRatedEntity>): List<Movies>{
        return initial.map { mapToDomainModel(it) }
    }

    fun toEntityList(initial: List<Movies>): List<MovieTopRatedEntity>{
